...
void print_help() {
    std::cout << "Usage: ./frustration_index <graph.csv> [graph2.csv ...] [--model=xy|x|mod] [--netdeg] [--negcycles] [--triangles] [--svg] [--help]\n";
    std::cout << "\nOptions:\n";
    ...
    std::cout << "\nNotes:\n";
    std::cout << "  Passing both --negcycles and --triangles enables the TriangleCyclePipeline.\n";
}
